...
const Settings = () => {
  ...
  return (
    <div className="my-10 flex rounded">
      {/* Side Menu */}
      <aside className="w-64 border-r" aria-label="Sidebar">
        <div className="overflow-y-auto py-4 px-3 rounded bg-white rounded ml-2">
      ...
      {/* Right Side */}
      <div className="bg-white p-6 w-full mr-10">
        <label
          for="website-admin"
